...
import type DefaultBooleanSchemaNode from './DefaultBooleanSchemaNode'

export default class BooleanSchemaNode<
  Out,
  Optional extends boolean,
  Nullable extends boolean,
  JSchema extends JsonSchemaFragment,
  OSchema extends OpenApiSchemaFragment
> extends SchemaNodeBase<boolean, Out, Optional, Nullable, JSchema, OSchema> {
  static default(): DefaultBooleanSchemaNode {
    return new BooleanSchemaNode(
      false,
      false,
