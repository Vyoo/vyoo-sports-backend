...
const defaults = {
  ...
  REST_API_NAME: 'VyooSportsRestApi',
  HTTP_API_NAME: 'VyooSportsHttpApi',
  WEBSOCKET_API_NAME: 'VyooSportsWebsocketApi',
  ...
  API_GATEWAY_REST_API_ID_EXPORT_NAME: 'VyooSportsApiGateway-restApiId',

  API_GATEWAY_ROOT_RESOURCE_ID_EXPORT_KEY: 'apiGatewayRootResourceId',
  API_GATEWAY_ROOT_RESOURCE_ID_EXPORT_NAME: 'VyooSportsApiGateway-rootResourceId',

  API_GATEWAY_RESOURCE_EXPORT_KEY_PREFIX: 'apiGatewayResource',
  API_GATEWAY_RESOURCE_EXPORT_NAME_PREFIX: 'VyooSportsApiGateway-resource-',

  API_GATEWAY_HTTP_API_ID_EXPORT_KEY: 'apiGatewayHttpApiId',
  API_GATEWAY_HTTP_API_ID_EXPORT_NAME: 'VyooSportsApiGateway-httpApiId',

  API_GATEWAY_WEBSOCKET_API_ID_EXPORT_KEY: 'apiGatewayWebsocketApiId',
  API_GATEWAY_WEBSOCKET_API_ID_EXPORT_NAME: 'VyooSportsApiGateway-websocketApiId',

  COGNITO_USER_POOL_NAME_EXPORT_KEY: 'cognitoUserPoolName',
  COGNITO_USER_POOL_NAME_EXPORT_NAME: 'VyooSportsCognitoUserPool-name',
}
